...
|     字段      |                    值                     |
|-------------|------------------------------------------|
| HTTP URL    | https://api.dingtalk.com/v1.0/yida/forms |
| HTTP Method | GET                                      |
...
| formTypes   | String  | 否    | 表单类型。 * **receipt**：普通单据表单 * **process**：流程表单 <br /> * 不传时两种表单均返回。 * 如需查询多种类型，可用英文逗号分隔。                                  |
| pageSize    | Integer | 否    | 每页条目数，默认值100，最大值100。                                                                                                     |
| pageNumber  | Integer | 否    | 页码，不传默认为1。                                                                                                               |
...
```HTTP
GET /v1.0/yida/forms?appType=APP_PBKTxxxxx&systemToken=FO86xxxxx&formTypes=receipt,process&pageSize=100&pageNumber=1&userId=5014xxxxx HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.GetFormListInAppHeaders getFormListInAppHeaders = new com.aliyun.dingtalkyida_1_0.models.GetFormListInAppHeaders();
        getFormListInAppHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.GetFormListInAppRequest getFormListInAppRequest = new com.aliyun.dingtalkyida_1_0.models.GetFormListInAppRequest()
                .setAppType("APP_PBKTxxxxx")
                .setSystemToken("FO86xxxxx")
                .setFormTypes("receipt,process")
                .setPageSize(100)
                .setPageNumber(1)
                .setUserId("5014xxxxx");
        try {
            client.getFormListInAppWithOptions(getFormListInAppRequest, getFormListInAppHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_form_list_in_app_headers = dingtalkyida__1__0_models.GetFormListInAppHeaders()
        get_form_list_in_app_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_form_list_in_app_request = dingtalkyida__1__0_models.GetFormListInAppRequest(
            app_type='APP_PBKTxxxxx',
            system_token='FO86xxxxx',
            form_types='receipt,process',
            page_size=100,
            page_number=1,
            user_id='5014xxxxx'
        )
        try:
            client.get_form_list_in_app_with_options(get_form_list_in_app_request, get_form_list_in_app_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_form_list_in_app_with_options_async(get_form_list_in_app_request, get_form_list_in_app_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFormListInAppHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getFormListInAppRequest = new GetFormListInAppRequest([
            "appType" => "APP_PBKTxxxxx",
            "systemToken" => "FO86xxxxx",
            "formTypes" => "receipt,process",
            "pageSize" => 100,
            "pageNumber" => 1,
            "userId" => "5014xxxxx"
        ]);
        try {
            $client->getFormListInAppWithOptions($getFormListInAppRequest, $getFormListInAppHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  getFormListInAppHeaders := &dingtalkyida_1_0.GetFormListInAppHeaders{}
  getFormListInAppHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getFormListInAppRequest := &dingtalkyida_1_0.GetFormListInAppRequest{
    AppType: tea.String("APP_PBKTxxxxx"),
    SystemToken: tea.String("FO86xxxxx"),
    FormTypes: tea.String("receipt,process"),
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetFormListInAppWithOptions(getFormListInAppRequest, getFormListInAppHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getFormListInAppHeaders = new $dingtalkyida_1_0.GetFormListInAppHeaders({ });
    getFormListInAppHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getFormListInAppRequest = new $dingtalkyida_1_0.GetFormListInAppRequest({
      appType: "APP_PBKTxxxxx",
      systemToken: "FO86xxxxx",
      formTypes: "receipt,process",
      pageSize: 100,
    ...
    try {
      await client.getFormListInAppWithOptions(getFormListInAppRequest, getFormListInAppHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormListInAppHeaders getFormListInAppHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormListInAppHeaders();
            getFormListInAppHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormListInAppRequest getFormListInAppRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormListInAppRequest
            {
                AppType = "APP_PBKTxxxxx",
                SystemToken = "FO86xxxxx",
                FormTypes = "receipt,process",
            ...
            try
            {
                client.GetFormListInAppWithOptions(getFormListInAppRequest, getFormListInAppHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| data        | Array   | 返回的表单列表。                                      |
| formType    | String  | 表单类型。 * **receipt**：普通单据表单 * **process**：流程表单 |
| creator     | String  | 创建者userId。                                    |
| formUuid    | String  | 表单ID。                                         |
| gmtCreate   | String  | 表单创建时间，iso8601格式，例如：2022-07-29T14:55Z。        |
| title       | Object  | 表单名称信息。                                       |
| enUS        | String  | 表单英文名称。                                       |
| zhCN        | String  | 表单中文名称。                                       |
| totalCount  | Integer | 总条数。                                          |
| currentPage | Integer | 分页参数，当前页码。                                    |
...

{
  ...
  "result" : {
    "data" : [ {
      "formType" : "process",
      "creator" : "501xxxxx",
      "formUuid" : "FORM-BAxxxxx",
      "gmtCreate" : "2022-10-27T11:09Z",
      "title" : {
        "enUS" : "process form test",
        "zhCN" : "流程表单示例"
      }
    } ],
    "totalCount" : 8,
