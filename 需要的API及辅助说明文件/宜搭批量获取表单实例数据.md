...
调用本接口，批量获取表单实例详情信息，包括实例名称、实例提交人等信息。  
...
|     字段      |                              值                               |
|-------------|--------------------------------------------------------------|
| HTTP URL    | https://api.dingtalk.com/v1.0/yida/forms/instances/ids/query |
| HTTP Method | POST                                                         |
...
| formInstanceIdList    | Array of String | 是    | 宜搭表单实例Id，调用[获取实例ID列表](https://open.dingtalk.com/document/development/api-getinstanceidlist-v2#)接口或者[获取多个表单实例ID](https://open.dingtalk.com/document/development/api-searchformdataidlist-v2#)接口获取。 |
| needFormInstanceValue | Boolean         | 否    | 是否需要宜搭表单组件格式的实例数据。 * **true**：需要 * **false**：不需要                                                                                                                                                  |
...
```HTTP
POST /v1.0/yida/forms/instances/ids/query HTTP/1.1
...

{
  ...
  "formInstanceIdList" : [ "FINST-J8766S91O2UYN87ZX3XOF1MY8MBA2912BSV0L24" ],
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        batchGetFormDataByIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
        ...
        try {
            client.batchGetFormDataByIdListWithOptions(batchGetFormDataByIdListRequest, batchGetFormDataByIdListHeaders, new RuntimeOptions());
...
class Sample {
    ...
    public static function main($args){
        ...
        $batchGetFormDataByIdListHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $batchGetFormDataByIdListRequest = new BatchGetFormDataByIdListRequest([
            "formUuid" => "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
            "appType" => "APP_XCE0EVXS6DYG3YDYC5RD",
            "systemToken" => "09866181UTZVVD4R3DC955FNKIM52HVPU5WWK7",
            "formInstanceIdList" => [
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let batchGetFormDataByIdListHeaders = new $dingtalkyida_1_0.BatchGetFormDataByIdListHeaders({ });
    batchGetFormDataByIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let batchGetFormDataByIdListRequest = new $dingtalkyida_1_0.BatchGetFormDataByIdListRequest({
      formUuid: "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
      appType: "APP_XCE0EVXS6DYG3YDYC5RD",
      systemToken: "09866181UTZVVD4R3DC955FNKIM52HVPU5WWK7",
      formInstanceIdList: [
    ...
    try {
      await client.batchGetFormDataByIdListWithOptions(batchGetFormDataByIdListRequest, batchGetFormDataByIdListHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                client.BatchGetFormDataByIdListWithOptions(batchGetFormDataByIdListRequest, batchGetFormDataByIdListHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
|       名称        |   类型   |                              描述                              |
|-----------------|--------|--------------------------------------------------------------|
| result          | Array  | 表单实例数据列表。                                                    |
| createTimeGMT   | String | 表单创建时间。                                                      |
| modifyUser      | Object | 修改该实例的员工信息。                                                  |
| name            | Object | 员工名字。                                                        |
| nameInChinese   | String | 中文名字。                                                        |
| nameInEnglish   | String | 英文名字。                                                        |
| userId          | String | 员工userId。                                                    |
| sequence        | String | 该表单实例对应的批量导入的批次号。 <br /> <br /> 如果是通过批量导入创建的实例，返回该字段。 <br /> |
...
| formData        | Map    | 表单实例数据。                                                      |
| originator      | Object | 表单提交人信息。                                                     |
| name            | Object | 表单提交人的名字信息。                                                  |
| nameInChinese   | String | 表单提交人中文名字。                                                   |
| nameInEnglish   | String | 表单提交人的英文名字。                                                  |
| userId          | String | 提交人的userId。                                                  |
| formInstanceId  | String | 表单实例Id。                                                      |
| id              | Long   | 数据库表记录主键Id。                                                  |
| title           | String | 实例标题。                                                        |
| version         | Long   | 该表单实例对应的表单schema版本。                                          |
| instanceValue   | String | 宜搭表单实例数据以宜搭组件格式展示。                                           |
