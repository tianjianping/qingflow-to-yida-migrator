...
|                                    **基本信息**                                    ||
|-------------|-------------------------------------------------------------------|
| HTTP URL    | https://api.dingtalk.com/v2.0/yida/forms/instances/insertOrUpdate |
| HTTP Method | POST                                                              |
...
|         名称          |   类型    | 是否必填 |                                                                    描述                                                                    |
|---------------------|---------|------|------------------------------------------------------------------------------------------------------------------------------------------|
| noExecuteExpression | Boolean | 否    | 是否不要触发表单绑定的校验规则、关联业务规则和第三方服务回调。 * **true**：不触发。 * **false**：触发 **说明** 该参数值传true可以降低API的耗时。                                               |
...
| searchCondition     | String  | 是    | 用于检索表单实例数据的检索条件，格式参考[表单筛选组件格式](https://open.dingtalk.com/document/development/instructions-for-creating-or-updating-form-data-format)。   |
...
| formDataJson        | String  | 是    | 用于更新或新增表单实例的数据，格式参考[创建或更新表单数据格式](https://open.dingtalk.com/document/development/instructions-for-creating-or-updating-form-data-format)。 |
...
| userId              | String  | 是    | 用户的userId，可通过[获取部门用户userid列表](https://open.dingtalk.com/document/development/query-the-list-of-department-userids.md)接口获取。               |
| useAlias            | Boolean | 否    | 是否使用组件别名；开启之后searchCondition、formDataJson可传入组件别名进行使用；                                                                                    |
...
```HTTP
POST /v2.0/yida/forms/instances/insertOrUpdate HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:678tugshi
Content-Type:application/json

{
  "noExecuteExpression" : false,
  "formUuid" : "FORM-GxxxxKA",
  ...
  "appType" : "APP_XCxxxx5RD",
  "formDataJson" : "{\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}]}",
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        createOrUpdateFormDataHeaders.xAcsDingtalkAccessToken = "<your access token>";
...
class Sample {
    ...
    public static function main($args){
        ...
        try {
            $client->createOrUpdateFormDataWithOptions($createOrUpdateFormDataRequest, $createOrUpdateFormDataHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
class Client {
  ...
  static async main(args) {
    ...
    let createOrUpdateFormDataHeaders = new dingtalkyida_2_0.CreateOrUpdateFormDataHeaders({ });
    createOrUpdateFormDataHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let createOrUpdateFormDataRequest = new dingtalkyida_2_0.CreateOrUpdateFormDataRequest({ });
    try {
      await client.createOrUpdateFormDataWithOptions(createOrUpdateFormDataRequest, createOrUpdateFormDataHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.CreateOrUpdateFormDataHeaders createOrUpdateFormDataHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.CreateOrUpdateFormDataHeaders();
            createOrUpdateFormDataHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.CreateOrUpdateFormDataRequest createOrUpdateFormDataRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.CreateOrUpdateFormDataRequest();
            try
            {
                client.CreateOrUpdateFormDataWithOptions(createOrUpdateFormDataRequest, createOrUpdateFormDataHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
|   名称   |       类型        |       描述        |
|--------|-----------------|-----------------|
| result | Array of String | 新增的或者更新的表单实例Id。 |
