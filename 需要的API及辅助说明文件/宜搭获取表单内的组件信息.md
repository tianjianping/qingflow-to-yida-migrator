...
|     字段      |                          值                          |
|-------------|-----------------------------------------------------|
| HTTP URL    | https://api.dingtalk.com/v1.0/yida/forms/formFields |
| HTTP Method | GET                                                 |
...
| formUuid    | String | 是    | 表单唯一标识，可通过以下方式获取： * 调用[获取指定应用下的表单列表](https://open.dingtalk.com/document/development/depending-on-the-application-id-to-get-the-form-list#)接口获取formUuid参数值。 * 通过应用获取： ![](https://img.alicdn.com/imgextra/i2/O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png) |
| userId      | String | 是    | 操作人userId，可通过[获取部门用户userid列表](https://open.dingtalk.com/document/development/query-the-list-of-department-userids#)接口获取。                                                                                                                                                 |
...
```HTTP
GET /v1.0/yida/forms/formFields?appType=APP_PBKxxxxx&systemToken=FO8xxxxx&formUuid=FORM-J7xxxxx&userId=5014xxxxx HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        getFieldDefByUuidHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.GetFieldDefByUuidRequest getFieldDefByUuidRequest = new com.aliyun.dingtalkyida_1_0.models.GetFieldDefByUuidRequest()
                .setAppType("APP_PBKxxxxx")
                .setSystemToken("FO8xxxxx")
                .setFormUuid("FORM-J7xxxxx")
                .setUserId("5014xxxxx");
        try {
            client.getFieldDefByUuidWithOptions(getFieldDefByUuidRequest, getFieldDefByUuidHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_field_def_by_uuid_headers = dingtalkyida__1__0_models.GetFieldDefByUuidHeaders()
        get_field_def_by_uuid_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_field_def_by_uuid_request = dingtalkyida__1__0_models.GetFieldDefByUuidRequest(
            app_type='APP_PBKxxxxx',
            system_token='FO8xxxxx',
            form_uuid='FORM-J7xxxxx',
            user_id='5014xxxxx'
        )
        try:
            client.get_field_def_by_uuid_with_options(get_field_def_by_uuid_request, get_field_def_by_uuid_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_field_def_by_uuid_with_options_async(get_field_def_by_uuid_request, get_field_def_by_uuid_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFieldDefByUuidRequest = new GetFieldDefByUuidRequest([
            "appType" => "APP_PBKxxxxx",
            "systemToken" => "FO8xxxxx",
            "formUuid" => "FORM-J7xxxxx",
            "userId" => "5014xxxxx"
        ]);
        try {
            $client->getFieldDefByUuidWithOptions($getFieldDefByUuidRequest, $getFieldDefByUuidHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  getFieldDefByUuidHeaders := &dingtalkyida_1_0.GetFieldDefByUuidHeaders{}
  getFieldDefByUuidHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getFieldDefByUuidRequest := &dingtalkyida_1_0.GetFieldDefByUuidRequest{
    AppType: tea.String("APP_PBKxxxxx"),
    SystemToken: tea.String("FO8xxxxx"),
    FormUuid: tea.String("FORM-J7xxxxx"),
    UserId: tea.String("5014xxxxx"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetFieldDefByUuidWithOptions(getFieldDefByUuidRequest, getFieldDefByUuidHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getFieldDefByUuidHeaders = new $dingtalkyida_1_0.GetFieldDefByUuidHeaders({ });
    getFieldDefByUuidHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getFieldDefByUuidRequest = new $dingtalkyida_1_0.GetFieldDefByUuidRequest({
      appType: "APP_PBKxxxxx",
      systemToken: "FO8xxxxx",
      formUuid: "FORM-J7xxxxx",
      userId: "5014xxxxx",
    ...
    try {
      await client.getFieldDefByUuidWithOptions(getFieldDefByUuidRequest, getFieldDefByUuidHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFieldDefByUuidHeaders getFieldDefByUuidHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFieldDefByUuidHeaders();
            getFieldDefByUuidHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFieldDefByUuidRequest getFieldDefByUuidRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFieldDefByUuidRequest
            {
                AppType = "APP_PBKxxxxx",
                SystemToken = "FO8xxxxx",
                FormUuid = "FORM-J7xxxxx",
            ...
            try
            {
                client.GetFieldDefByUuidWithOptions(getFieldDefByUuidRequest, getFieldDefByUuidHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
|      名称       |   类型    |                                                                                                                                                                                                    描述                                                                                                                                                                                                     |
|---------------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| success       | Boolean | 接口调用是否成功，true表示调用成功。                                                                                                                                                                                                                                                                                                                                                                                      |
| result        | Array   | 获取的表单组件列表。                                                                                                                                                                                                                                                                                                                                                                                                |
| componentName | String  | 组件类型，常见类型如下所示。 * **DateField**：日期 * **TextField**：单行文本 * **TextareaField**：多行文本 * **NumberField**：数值 * **RateField**：评分 * **RadioField**：单选 * **CheckboxField**：复选 * **SelectField**：下拉单选 * **MultiSelectField**：下拉复选 * **CascadeSelectField**：级联选择 * **CascadeDateField**：日期区间 * **ImageField**：图片上传 * **AttachmentField**：附件 * **EmployeeField**：成员 * **TableField**：子表单 * **DepartmentSelectField**：部门 |
| fieldId       | String  | 组件ID，组件唯一标识。                                                                                                                                                                                                                                                                                                                                                                                              |
| behavior      | String  | 组件展示状态。 * **NORMAL**：普通 * **DISABLED**：禁用 * **READONLY**：只读 * **HIDDEN**：隐藏                                                                                                                                                                                                                                                                                                                               |
| label         | Any     | 组件名称。                                                                                                                                                                                                                                                                                                                                                                                                     |
| props         | Any     | 组件属性。                                                                                                                                                                                                                                                                                                                                                                                                     |
| children      | String  | 子组件信息。                                                                                                                                                                                                                                                                                                                                                                                                    |
...

{
  ...
  "result" : [ {
    ...
    "fieldId" : "textField_laq7xxx",
    "behavior" : "NORMAL",
    "label" : "{ \"use\":\"zh_CN\", \"en_US\":\"TextField\", \"zh_CN\":\"单行文本\",\"type\":\"JSExpression\", \"value\":\"\\\"单行文本\\\"\", \"extType\":\"i18n\"}",
    "props" : "{\"dataSource\":[]}",
    "children" : "[{\"componentName\":\"TextField\",\"label\":{\"use\":\"zh_CN\",\"en_US\":\"TextField\",\"zh_CN\":\"单行文本\",\"type\":\"JSExpression\",\"value\":\"单行文本\",\"extType\":\"i18n\"},\"behavior\":\"NORMAL\",\"fieldId\":\"textField_lb0aai0j\",\"props\":{}}]"
  } ]
}
```
